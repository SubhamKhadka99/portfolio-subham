    ...
    projects: [
        {
            ...
            description: 'Building a comprehensive RESTful API for an e-commerce platform with authentication, product management, cart functionality, and order processing.',
            tech: ['Node.js', 'Express.js', 'MongoDB', 'JWT'],
            status: 'In Development',
            link: null // Add GitHub link or null if not available
        },
        {
            title: 'Student Management System',
            description: 'A Java-based application for managing student records, attendance, and grades with an intuitive user interface.',
